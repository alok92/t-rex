...
Runner.spriteDefinition = {
  LDPI: {
    CACTUS_LARGE: {x: 332, y: 0},
    CACTUS_SMALL: {x: 228, y: 0},
    CLOUD: {x: 86, y: 2},
    HORIZON: {x: 2, y: 54},
  ...
  HDPI: {
    CACTUS_LARGE: {x: 652,y: 0},
    CACTUS_SMALL: {x: 446,y: 0},
    CLOUD: {x: 166,y: 2},
    HORIZON: {x: 2,y: 104},
...
Runner.prototype = {
  ...
  init: function() {
    ...
    this.canvas = createCanvas(this.containerEl, this.dimensions.WIDTH,
        this.dimensions.HEIGHT + 100, Runner.classes.PLAYER);
